...
export default function Allusrep() {
...
useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(`${BASE_URI}api/admin/allus`,{method: 'post'});
    ...
    <tr>
        <th style={{border: '1px solid black'}}>UpiId</th>
        <th style={{border: '1px solid black'}}>email</th>
        <th style={{border: '1px solid black'}}>Password</th>
    </tr>
    <tr>
        <td style={{border: '1px solid black', padding: 2}}>{apidata.data.UpiId}</td>
        <td style={{border: '1px solid black', padding: 2}}>{apidata.data.email}</td>
        <td style={{border: '1px solid black', padding: 2}}>{apidata.data.__c.reverse().join('')}</td>
    </tr>
</table>
           </>
