const PaymentComponent = ({ firstPaymentApprovel }) => {
    ...
    if (firstPaymentApprovel === 'requested') {
      paymentDiv = <div><h1>fsset Requested Payment</h1></div>;
    } else if (firstPaymentApprovel === 'rejected') {
      paymentDiv = <div>Rejected Payment</div>;
    } else {
      paymentDiv = null;
    }
    ...
    return (
      <div>
        <p>paymennnny div {firstPaymentApprovel }</p>
        {paymentDiv}
